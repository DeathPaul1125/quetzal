  ...
  <div class="col-xl-10 col-lg-12 col-md-9">
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-lg-6 d-none d-lg-block bg-login-image" style="background: url(<?php echo IMAGES; ?>quetzal.svg); background-size: 60%; background-position: center center; background-repeat: no-repeat;" ></div>
          <div class="col-lg-6">
            <div class="p-5">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-12 mb-3 text-center">
                    ...
                    <?php if (is_demo() || is_local()) : ?>
                      <small class="text-muted">Ingresa admin</small>
                    <?php endif; ?>
                  </div>
              ...
              <div class="text-center">
                <a class="small" href="<?php echo build_url('quetzal/generate-user'); ?>">Crear nueva cuenta</a>
              </div>
            </div>
          </div>
        </div>
