...
class carritoController extends Controller implements ControllerInterface
{
  ...
  function __construct()
  {
    ...
    $this->cartHandler= new QuetzalCartHandler();
    ...
    if ($couponCode !== null) {
      ...
      if ($couponCode == $validCouponCode) {
        ...
        $coupon     = new QuetzalCartCoupon($couponCode, 'Apoyo educativo de la Academia.', 50, 'percentage', strtotime('+5 days'));
  ...
  function agregar($itemId = null, $quantity = 1)
  {
    try {
      ...
      $item= new QuetzalCartItem($itemId, $producto['nombre'], $price, $quantity, $producto['descripcion'], $producto['imagen']);
