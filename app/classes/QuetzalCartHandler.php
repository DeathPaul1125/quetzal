...
final class QuetzalCartHandler
{
  /**
   ...
   *
   * @param QuetzalCartItem $item
   * @return bool
   */
  function addItem(QuetzalCartItem $item)
  {
   ...
   *
   * @param QuetzalCartCustomer $customer
   * @return void
   */
  function addCustomer(QuetzalCartCustomer $customer)
  {
   ...
   *
   * @param QuetzalCartShipping $shipping
   * @return void
   */
  function addShipping(QuetzalCartShipping $shipping)
  {
   ...
   *
   * @param QuetzalCartCoupon $coupon
   * @return void
   */
  function addCoupon(QuetzalCartCoupon $coupon)
  {
