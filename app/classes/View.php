...
class View {
  ...
  {
    // Todas las funciones definidas y cargadas en Quetzal
  ...
  /**
   * Renderiza una vista con el motor de Quetzal
   *
   * @param string $view
   * @param array $data
   * @return void
  ...
  {
    QuetzalHookManager::runHook('on_get_twig_filters', $this->twigIntance); // Permite registrar nuevos filtros
  ...
  {
    QuetzalHookManager::runHook('on_get_twig_functions', $this->twigIntance); // Permite registrar nuevas funciones
