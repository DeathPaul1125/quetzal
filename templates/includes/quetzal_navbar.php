<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container">
    <a class="navbar-brand" href="<?php echo get_base_url(); ?>">
      <img src="<?php echo get_quetzal_logo(); ?>" alt="<?php echo get_quetzal_name(); ?>" width="100px">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="quetzal">Inicio</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="utilidades">
            ...
            <li><a class="dropdown-item" href="quetzal/info">Quetzal info</a></li>
            <li><a class="dropdown-item" href="quetzal/password">Generar contraseña</a></li>
            <li><a class="dropdown-item" href="<?php echo build_url('quetzal/generate-user'); ?>">Crear nuevo usuario</a></li>
            <li><a class="dropdown-item" href="<?php echo build_url('quetzal/regenerate'); ?>">Regenerar credenciales</a></li>
