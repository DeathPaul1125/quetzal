      ...
      <div class="col-12 offset-md-3 col-md-6">
        <div class="card shadow-sm">
          <div class="card-body">
            ...
            <p>Para crear un formulario basta con instanciar nuestra clase <code>QuetzalFormBuilder</code> y esta requiere 6 parámetros: <code>$name, $id, $classes, $action, $post, $sendFiles</code></p>
            <?php echo code_block(
'$form= new QuetzalFormBuilder(
...
'$form->addButton(
  ...
  \'submit\'              // id del botón
            ...
            <p><code>QuetzalFormBuilder</code> tiene incorporada la funcionalidad para generar un script para enviar la información del formulario usando <code>AJAX</code> con Javascript vanilla y <code>fetch()</code>, para esto basta con utilizar el método <code>generateFetchScript($url, $accessToken, $addEventListener)</code> y requiere 3 parámetros, el primero es obligatorio <code>$url</code> y representa la URL o script que procesará la información del formulario:</p>
            <?php echo code_block(
